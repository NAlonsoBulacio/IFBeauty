...
// block(
  ...
  return (
    <div className="w-full flex flex-wrap justify-center px-0 lg:px-4 space-y-3">
      ...
      <iframe width="100%" height="315" src="https://www.youtube-nocookie.com/embed/823CWbtbyVA?si=i9gXvbOD42-rn5I4&amp;controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      </div>
      {showForm && (
        <>
          <div
