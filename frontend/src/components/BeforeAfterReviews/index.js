...
const before_after = [
    ...
    //     name: "Maria D.",
    //     description:
    //       "I am amazed by the results of this serum! My skin looks brighter and more youthful. It feels hydrated and smooth. Definitely recommend it to everyone!",
    //     img: b2,
    //   },
      {
        name: "Laura B.",
      ...
      //   name: "Emily S.",
      //   description:
      //     "This serum has become a staple in my skincare routine. It's lightweight, yet incredibly effective. My skin looks more radiant and feels firmer. Highly recommend it!",
      //   img: b4,
      // },
      {
        name: "Sophia M.",
